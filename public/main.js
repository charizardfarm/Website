...
var web3 = new Web3(
  ...
  var farmingAddress = "0xf2834941711c4a98c559f0b0a3c06e7560259a48"; //farming address
  const tokenAddress = "0xB23b0EF01235fAEE77110e96854ca937f09442C6"; // token
...
var pools = [
  [
    ...
    "UNISWAP CRZF/ETH",
    "https://uniswap.info/pair/0xcccc4a5e13b26391cb465b5c06e6257471eebbcc",
    6,
    0,
    0,
    "10984750"
  ...
  [
    ...
    "UNISWAP UNI/CRZF",
    "https://uniswap.info/pair/0x8c96a9557405c9be6c156a208a953b3fc890c8df",
    6,
    0,
    0,
    "10984750"
  ...
  function getBalance(address) {
    ...
    contract.methods.balanceOf(address).call(function (error, result) {
      contract.methods.decimals().call(function (error, d) {
        ...
        $(".balance").text(result.toFixedSpecial(2) + " CRZF");
        balance = result;
      });
    });
  }
  ...
  function initpooldata(id) {
    ...
    contract.methods
    .pendingCharizard(currentPagePoolID, ethaddress)
    .call(function (error, result) {
